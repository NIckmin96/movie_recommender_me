...
def main():
    ...
    # user_seq : groupby(user) -> item -> list append / max_item : max value in item set union / long_sequence : groupby(user) -> item -> list extend

    item2attribute, attribute_size = get_item2attribute_json(item2attribute_file)
    #item2attribute : json file read / attribute_size : max value in attribute set union

    args.item_size = max_item + 2 # ? nn.Embedding 
    args.mask_id = max_item + 1 # nn.Embedding
    args.attribute_size = attribute_size + 1 # ? nn.Embedding
